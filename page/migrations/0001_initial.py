    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ein', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('type', models.CharField(choices=[('nonprofit', 'Nonprofit'), ('personal', 'Personal'), ('religious', 'Religious'), ('other', 'Other')], default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(blank=True, null=True, upload_to=page.models.upload_to)),
