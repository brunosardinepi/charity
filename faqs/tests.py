...
class FAQTest(TestCase):
    ...
    def test_faq_page(self):
        ...
        self.assertContains(response, '<span id="score-{}">{}</span>'.format(self.faq.pk, self.faq.score()))
        self.assertContains(response, self.faq2.question)
        self.assertContains(response, self.faq2.answer)
        self.assertContains(response, '<span id="score-{}">{}</span>'.format(self.faq2.pk, self.faq2.score()))
