...
#    url(r'^accounts/password/reset/', views.PasswordResetView.as_view(), name='password_reset'),
    ...
    url(r'^profile/image/delete/', include('userprofile.urls', namespace='user_image_delete')),
    url(r'^profile/image/update/', include('userprofile.urls', namespace='user_profile_update')),
